...
# Modified from the file: https://github.com/patsyuk03/RobotiqHandeROS2Driver/blob/main/robotiq_hande_ros2_driver/robotiq_hande_ros2_driver/gripper_node.py
